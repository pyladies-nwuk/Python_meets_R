...
- Tienes que acceder en: http://40.87.67.31

- Disponible sólo por hoy

## En casa:

- El repositorio es: https://github.com/pyladies-nwuk/Python_meets_R
...
`r emo::ji("snake")` En Python `np` aplicamos los métodos de la siguiente forma: 
